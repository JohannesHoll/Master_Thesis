...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    ##saving file
    df_daily_stock_prices.to_csv(r'C:\Users\victo\Master_Thesis\stockprice_data\peugeot\daily_stock_pricefiles_with_return\peugeotprices_with_onehotencoding.csv', index=False)
