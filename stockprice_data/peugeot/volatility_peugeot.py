...
path = r'C:\Users\victo\Master_Thesis\stockprice_data\peugeot\daily_stock_prices\peugeot_prices_' + date + '.csv'    
...
plt.title('Price Evolution of Peugeot on ' + date)
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_data\peugeot\plotted_evolution_of_daily_stock_prices\price_evolution_of_Peugeot_on_' + date + '.png', bbox_inches="tight")
