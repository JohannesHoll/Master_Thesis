...
path = r'C:\Users\victo\Master_Thesis\stockprice_data\ferrari\daily_stock_prices\ferrari_prices_' + date + '.csv'    
...
plt.title('Price Evolution of Ferrari on ' + date)
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_data\ferrari\plotted_evolution_of_daily_stock_prices\price_evolution_of_Ferrari_on_' + date + '.png', bbox_inches="tight")
