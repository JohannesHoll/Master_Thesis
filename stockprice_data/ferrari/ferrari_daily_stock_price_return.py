...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    ##saving file
    df_daily_stock_prices.to_csv(r'C:\Users\victo\Master_Thesis\stockprice_data\ferrari\daily_stockpricefiles_with_return\ferrariprices_with_onehotencoding.csv', index=False)
