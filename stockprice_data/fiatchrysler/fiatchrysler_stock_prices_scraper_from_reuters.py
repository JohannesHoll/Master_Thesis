...
df = ek.get_timeseries(rics=rics,
                       fields=fields, 
                       start_date=str(modified_date_minus_one) + 'T09:00:00',#'2020-01-02T09:00:00', 
                       end_date=str(modified_date_minus_one) + 'T22:01:00',#'2020-01-02T17:30:00', 
                       interval='minute') 
print(df)
#safe to csv
df.to_csv(r'C:\Users\victo\Master_Thesis\stockprice_data\fiatchrysler\stock_prices\fiatchrysler_prices_' + str(modified_date_minus_one) + '.csv')