...
path = r'C:\Users\victo\Master_Thesis\stockprice_data\volvo\daily_stock_prices\volvo_prices_' + date + '.csv'    
...
plt.title('Price Evolution of Volvo on ' + date)
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_data\volvo\plotted_evolution_of_daily_stock_prices\price_evolution_of_Volvo_on_' + date + '.png', bbox_inches="tight")
