...
path = r'C:\Users\victo\Master_Thesis\stockprice_data\porsche\daily_stock_prices\porsche_prices_' + date + '.csv'    
...
plt.title('Price Evolution of Porsche on ' + date)
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_data\porsche\plotted_evolution_of_daily_stock_prices\price_evolution_of_BMW_on_' + date + '.png')
