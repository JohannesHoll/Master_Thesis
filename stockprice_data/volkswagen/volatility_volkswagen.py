...
path = r'C:\Users\victo\Master_Thesis\stockprice_data\volkswagen\daily_stock_prices\volkswagen_prices_' + date + '.csv'    
...
plt.title('Price Evolution of Volkswagen on ' + date)
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_data\volkswagen\plotted_evolution_of_daily_stock_prices\price_evolution_of_Volkswagen_on_' + date + '.png', bbox_inches="tight")
