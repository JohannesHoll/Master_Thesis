...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_data\daimler\plotted_evolution_of_daily_stock_prices\price_evolution_of_BMW_on_' + date + '.png', bbox_inches="tight")
