...
path = r'C:\Users\victo\Master_Thesis\stockprice_data\daimler\daily_stock_prices\daimler_prices_' + date + '.csv'    
...
plt.title('Price Evolution of Daimler on ' + date)
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_data\daimler\plotted_evolution_of_daily_stock_prices\price_evolution_of_Daimler_on_' + date + '.png', bbox_inches="tight")
