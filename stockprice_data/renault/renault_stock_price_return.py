...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    ##saving file
    df_daily_stock_prices.to_csv(r'C:\Users\victo\Master_Thesis\stockprice_data\renault\stockpricefiles_with_return\renaultprices_with_onehotencoding_' + date + '.csv', index=False)
