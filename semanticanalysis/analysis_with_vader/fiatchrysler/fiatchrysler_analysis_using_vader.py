...
cleaned_dataframe.to_csv(r'C:\Users\victo\Master_Thesis\sentimentanalysis\analysis_with_vader\fiatchrysler\outcome_using_vader\outcome_of_vader_on_fiatchrysler_news_' + str(current_date) + '.csv', index=False)