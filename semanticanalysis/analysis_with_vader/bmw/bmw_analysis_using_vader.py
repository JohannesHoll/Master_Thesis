...
cleaned_dataframe.to_csv(r'C:\Users\victo\Master_Thesis\semanticanalysis\analysis_with_vader\bmw\outcome_using_vader\outcome_of_vader_on_bmw_news_' + str(current_date) + '.csv', index=False)