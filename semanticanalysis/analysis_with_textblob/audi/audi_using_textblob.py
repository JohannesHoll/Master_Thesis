...
cleaned_dataframe.to_csv(r'C:\Users\victo\Master_Thesis\semanticanalysis\analysis_with_textblob\audi\outcome_using_texblob\outcome_of_textblob_on_audi_news_' + str(current_date) + '.csv', index=False)