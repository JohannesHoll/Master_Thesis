...
cleaned_dataframe.to_csv(r'C:\Users\victo\Master_Thesis\sentimentanalysis\analysis_with_flair\porsche\outcome_using_flair\outcome_of_flair_on_porsche_news_' + str(current_date) + '.csv', index=False)