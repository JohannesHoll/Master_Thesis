...
cleaned_dataframe.to_csv(r'C:\Users\victo\Master_Thesis\semanticanalysis\analysis_with_flair\ferrari\outcome_using_flair\outcome_of_flair_on_ferrari_news_' + str(current_date) + '.csv', index=False)