...
from volvo_scraper.items import VolvoItem
import numpy as np
from scrapy.loader import ItemLoader
import csv
from datetime import datetime

#creating spider for Volvo

class FinanceNewsScraperSpider(scrapy.Spider):
    name = "volvonewsarticles"
    
    def start_requests(self):
        start_urls = ['https://www.reuters.com/companies/VOLVb.ST/news',
                      ]
    ...
    def parse_article(self, response):
        ...
        #saving data to file.
        path = 'news/'
        file = 'volvonews_' + str(datetime.now().strftime("%Y%m%d-%H%M")) + '.csv'
