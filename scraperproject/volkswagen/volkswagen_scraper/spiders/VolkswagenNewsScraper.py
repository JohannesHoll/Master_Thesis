...
#creating spider for Volkswagen

class FinanceNewsScraperSpider(scrapy.Spider):
    name = "volkswagennewsarticles"
    
    def start_requests(self):
        start_urls = ['https://www.reuters.com/companies/VOWG_p.DE/news',
                      ]
    ...
    def parse_article(self, response):
        ...
        #saving data to file.
        path = 'news/'
        file = 'volkswagennews_' + str(datetime.now().strftime("%Y%m%d-%H%M")) + '.csv'
