...
from peugeot_scraper.items import PeugeotItem
import numpy as np
from scrapy.loader import ItemLoader
import csv
from datetime import datetime

#creating spider for Peugeot

class FinanceNewsScraperSpider(scrapy.Spider):
    name = "peugeotnewsarticles"
    
    def start_requests(self):
        start_urls = ['https://www.reuters.com/companies/PEUP.PA/news',
                      ]
    ...
    def parse_article(self, response):
        ...
        #saving data to file.
        path = 'news/'
        file = 'peugeotnews_' + str(datetime.now().strftime("%Y%m%d-%H%M")) + '.csv'
