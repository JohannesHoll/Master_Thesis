...
from renault_scraper.items import RenaultItem
import numpy as np
from scrapy.loader import ItemLoader
import csv
from datetime import datetime

#creating spider for Renault

class FinanceNewsScraperSpider(scrapy.Spider):
    name = "renaultnewsarticles"
    
    def start_requests(self):
        start_urls = ['https://www.reuters.com/companies/RENA.PA/news',
                      ]
    ...
    def parse_article(self, response):
        ...
        #saving data to file.
        path = 'news/'
        file = 'renaultnews_' + str(datetime.now().strftime("%Y%m%d-%H%M")) + '.csv'
