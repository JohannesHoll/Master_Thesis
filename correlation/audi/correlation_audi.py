...
if new_df['polarity_textblob_sentiment_header'].contains(r'POSTIVE'):
    value_postive = new_df['polarity_textblob_sentiment_header'].extract(r'\((.*?)\)', expand=False)
    print(value_postive)
elif new_df['polarity_textblob_sentiment_header'].contains(r'NEGATIVE'):
    value_negative = new_df['polarity_textblob_sentiment_header'].extract(r'\((.*?)\)', expand=False)
