...
path_stockprices = r'C:\Users\victo\Master_Thesis\stockprice_data\volvo\hourly_stockpricefiles_with_return'
...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    new_df_daily_stockprices.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\volvo\hourly\merged_files\volvoprices_hourly_with_semantics_' + date + '.csv', index=False)
