...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    new_df_daily_stockprices.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\bmw\hourly\merged_files\bmwprices_hourly_with_semantics_' + date + '.csv', index=False)
