...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    new_df_daily_stockprices.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\audi\hourly\merged_files\audiprices_hourly_with_semantics_' + date + '.csv', index=False)
