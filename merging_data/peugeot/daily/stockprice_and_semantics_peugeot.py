...
path_stockprices = r'C:\Users\victo\Master_Thesis\stockprice_data\peugeot\daily_stock_pricefiles_with_return'
...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    new_df_daily_stockprices.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\peugeot\daily\merged_files\daily_peugeotprices_with_semantics_.csv', index=False)
