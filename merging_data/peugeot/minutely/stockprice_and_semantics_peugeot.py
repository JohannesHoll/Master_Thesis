...
path_stockprices = r'C:\Users\victo\Master_Thesis\stockprice_data\peugeot\minutely_stockpricefiles_with_return'
...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    df_stock_prices_semantics.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\peugeot\minutely\merged_files\peugeotprices_with_semantics_' + date + '.csv', index=False)
