...
path_stockprices = r'C:\Users\victo\Master_Thesis\stockprice_data\porsche\hourly_stockpricefiles_with_return'
...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    new_df_daily_stockprices.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\porsche\hourly\merged_files\porscheprices_hourly_with_semantics_' + date + '.csv', index=False)
