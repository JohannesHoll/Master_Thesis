...
path_stockprices = r'C:\Users\victo\Master_Thesis\stockprice_data\daimler\hourly_stockpricefiles_with_return'
...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    new_df_daily_stockprices.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\daimler\hourly\merged_files\daimlerprices_hourly_with_semantics_' + date + '.csv', index=False)
