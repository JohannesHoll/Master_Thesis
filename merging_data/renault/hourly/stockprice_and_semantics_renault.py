...
path_flair = r'C:\Users\victo\Master_Thesis\semanticanalysis\analysis_with_flair\renault\outcome_using_flair'
...
path_vader = r'C:\Users\victo\Master_Thesis\semanticanalysis\analysis_with_vader\renault\outcome_using_vader'
...
path_textblob = r'C:\Users\victo\Master_Thesis\semanticanalysis\analysis_with_textblob\renault\outcome_using_texblob'
...
path_stockprices = r'C:\Users\victo\Master_Thesis\stockprice_data\renault\hourly_stockpricefiles_with_return'
...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    new_df_daily_stockprices.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\renault\hourly\merged_files\renaultprices_hourly_with_semantics_' + date + '.csv', index=False)
