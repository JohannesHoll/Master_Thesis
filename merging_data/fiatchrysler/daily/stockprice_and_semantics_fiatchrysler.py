...
path_stockprices = r'C:\Users\victo\Master_Thesis\stockprice_data\fiatchrysler\daily_stockpricefiles_with_return'
...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    new_df_daily_stockprices.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\fiatchrysler\daily\merged_files\daily_fiatchryslerprices_with_semantics_.csv', index=False)
