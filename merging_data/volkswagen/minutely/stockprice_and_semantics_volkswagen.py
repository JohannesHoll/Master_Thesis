...
path_stockprices = r'C:\Users\victo\Master_Thesis\stockprice_data\volkswagen\minutely_stockpricefiles_with_return'
...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    df_stock_prices_semantics.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\volkswagen\minutely\merged_files\volkswagenprices_with_semantics_' + date + '.csv', index=False)
