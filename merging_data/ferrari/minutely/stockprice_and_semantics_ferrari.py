...
path_stockprices = r'C:\Users\victo\Master_Thesis\stockprice_data\ferrari\minutely_stockpricefiles_with_return'
...
for file in glob.iglob(path_stockprices + '\*.csv'):
    ...
    df_stock_prices_semantics.to_csv(r'C:\Users\victo\Master_Thesis\merging_data\ferrari\minutely\merged_files\ferrariprices_with_semantics_' + date + '.csv', index=False)
