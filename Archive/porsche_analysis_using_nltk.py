...
cleaned_dataframe.to_csv(r'C:\Users\victo\Master_Thesis\sentimentanalysis\porsche\outcome_using_vader\outcome_of_vader_on_porsche_news_' + str(current_date) + '.csv', index=False)