...
cleaned_dataframe.to_csv(r'C:\Users\victo\Master_Thesis\sentimentanalysis\peugeot\outcome_using_vader\outcome_of_vader_on_peugeot_news_' + str(current_date) + '.csv', index=False)