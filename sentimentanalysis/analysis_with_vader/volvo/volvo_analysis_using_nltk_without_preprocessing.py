...
cleaned_dataframe.to_csv(r'C:\Users\victo\Master_Thesis\sentimentanalysis\analysis_with_vader\volvo\outcome_using_vader_without_preprocessing\outcome_of_vader_on_volvo_news_without_preprocessing_' + str(current_date) + '.csv', index=False)