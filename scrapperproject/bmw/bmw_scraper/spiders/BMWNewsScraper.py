...
from bmw_scraper.items import BMWItem
import numpy as np
from scrapy.loader import ItemLoader
import csv
from datetime import datetime

#creating spider for BMW

class FinanceNewsScraperSpider(scrapy.Spider):
    name = "bmwnewsarticles"
    
    def start_requests(self):
        start_urls = ['https://www.reuters.com/companies/BMWG.DE/news',
                      ]
    ...
    def parse_article(self, response):
        ...
        #saving data to file.
        path = 'news/'
        file = 'bmwnews_' + str(datetime.now().strftime("%Y%m%d-%H%M")) + '.csv'
