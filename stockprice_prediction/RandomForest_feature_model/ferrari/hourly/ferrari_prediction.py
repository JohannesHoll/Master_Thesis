...
plt.plot(RF_feature_model_predictions_flair_content, color='green', label='Predicted Ferrari Stock Price with flair content analysis')
plt.plot(RF_feature_model_predictions_flair_header, color='red', label='Predicted Ferrari Stock Price with flair header analysis')
plt.plot(RF_feature_model_predictions_textblob_content, color='orange', label='Predicted Ferrari Stock Price with textblob content analysis')
plt.plot(RF_feature_model_predictions_textblob_header, color='blue', label='Predicted Ferrari Stock Price with textblob header analysis')
plt.plot(RF_feature_model_predictions_vader_content, color='cyan', label='Predicted Ferrari Stock Price with vader content analysis')
plt.plot(RF_feature_model_predictions_vader_header, color='magenta', label='Predicted Ferrari Stock Price with vader header analysis')
plt.plot(RF_feature_model_predictions_without_semantics, color='yellow', label='Predicted Ferrari Stock Price without semantics analysis')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\RandomForest_feature_model\ferrari\hourly\prediction_ferrari_with_all_' + date_today + '.png',
            bbox_inches="tight",
            dpi=100,
            pad_inches=1.5)
plt.show()
