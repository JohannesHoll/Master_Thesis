...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\porsche\hourly\flair\header\prediction_plot_with_semantics\prediction_porsche_with_semantics_' + date_today + '.png', bbox_inches="tight")
