...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\RandomForest_feature_model\fiatchrysler\daily\prediction_fiatchrysler_with_all_' + date_today + '.png',
            bbox_inches="tight",
            dpi=100,
            pad_inches=1.5)
plt.show()
