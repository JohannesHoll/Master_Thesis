...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\daimler\minutely\flair\header\prediction_plot_with_semantics\prediction_daimler_with_semantics_' + date_today + '.png', bbox_inches="tight")
