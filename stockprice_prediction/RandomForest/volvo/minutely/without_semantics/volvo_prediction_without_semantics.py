...
new_df = concatenate_dataframe[['OPEN', 'HIGH', 'LOW', 'CLOSE', 'VOLUME']]
...
#model.save(r'C:\Users\victo\Master_Thesis\stockprice_prediction\volvo\resultstest' + date_today + '.h5')
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\volvo\minutely\without_semantics\prediction_plot_without_semantics\prediction_volvo_without_semantics_' + date_today + '.png', bbox_inches="tight")
