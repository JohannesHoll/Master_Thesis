...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\peugeot\daily\without_semantics\prediction_plot_without_semantics\prediction_peugeot_without_semantics_' + date_today + '.png', bbox_inches="tight")
