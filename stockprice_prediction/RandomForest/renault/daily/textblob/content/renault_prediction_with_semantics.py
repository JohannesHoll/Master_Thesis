...
#plt.plot(new_df.OPEN, color='black', label='renault Stock Price')
plt.plot(predicted_stock_price, color='green', label='Predicted renault Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\renault\daily\textblob\content\prediction_plot_with_semantics\prediction_renault_with_semantics_' + date_today + '.png', bbox_inches="tight")
