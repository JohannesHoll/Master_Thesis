...
path = r'C:\Users\victo\Master_Thesis\merging_data\renault\merged_files'
...
plt.plot(test_dataset, color = 'black', label = 'Renault Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\renault\without_semantics\prediction_plot_without_semantics\prediction_renault_without_semantics_' + date_today + '.png', bbox_inches="tight")
