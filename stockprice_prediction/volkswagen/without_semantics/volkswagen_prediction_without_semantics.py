...
path = r'C:\Users\victo\Master_Thesis\merging_data\volkswagen\merged_files'
...
plt.plot(test_dataset, color = 'black', label = 'Volkswagen Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\volkswagen\without_semantics\prediction_plot_without_semantics\prediction_volkswagen_without_semantics_' + date_today + '.png', bbox_inches="tight")
