...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\volkswagen\prediction_plot_without_semantics\prediction_volkswagen_without_semantics' + date_today + '.png', bbox_inches="tight")