...
FORECAST_DISTANCE_flair_content = 1
...
FORECAST_DISTANCE_flair_header = 1
...
FORECAST_DISTANCE_textblob_content = 1
...
FORECAST_DISTANCE_vader_content = 1
...
FORECAST_DISTANCE_vader_header = 1
...
FORECAST_DISTANCE_without_semantics = 1
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\volvo\daily\prediction_volvo_' + date_today + '.png',
            bbox_inches="tight",
            dpi=100,
            pad_inches=1.5)
plt.show()
