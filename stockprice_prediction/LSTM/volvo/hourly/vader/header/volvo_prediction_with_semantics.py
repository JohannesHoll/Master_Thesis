...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\volvo\hourly\vader\header\prediction_plot_with_semantics\prediction_volvo_with_semantics_' + date_today + '.png', bbox_inches="tight")
