...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\renault\hourly\without_semantics\prediction_plot_without_semantics\prediction_renault_without_semantics_' + date_today + '.png', bbox_inches="tight")
