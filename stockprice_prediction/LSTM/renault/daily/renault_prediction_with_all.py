...
#plt.plot(X_test_rolled_without_semantics['OPEN'], color='black', label='renault Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\renault\daily\prediction_renault_with_all_' + date_today + '.png',
            bbox_inches="tight",
            dpi=100,
            pad_inches=1.5)
plt.show()
