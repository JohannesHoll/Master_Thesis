...
real_price = X_test_rolled.inverse_transform(np.array(X_test_rolled).reshape(-1, 1))
...
plt.plot(real_price, color='black', label='bmw Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\bmw\hourly\vader\content\prediction_plot_with_semantics\prediction_bmw_with_vadercontent_' + date_today + '.png', bbox_inches="tight")
