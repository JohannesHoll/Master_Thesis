...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\bmw\daily\vader\content\prediction_plot_with_semantics\prediction_bmw_with_vadercontent_' + date_today + '.png', bbox_inches="tight")
