...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\bmw\daily\without_semantics\prediction_plot_without_semantics\prediction_bmw_without_semantics_' + date_today + '.png', bbox_inches="tight")
