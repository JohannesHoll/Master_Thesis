...
path = r'C:\Users\victo\Master_Thesis\merging_data\porsche\daily\merged_files'
...
#plt.plot(X_test_rolled_without_semantics['OPEN'], color='black', label='porsche Stock Price')
plt.plot(predicted_stock_price_flair_content, color='green', label='Predicted Porsche Stock Price with flair content analysis')
plt.plot(predicted_stock_price_flair_header, color='red', label='Predicted Porsche Stock Price with flair header analysis')
plt.plot(predicted_stock_price_textblob_header, color='yellow', label='Predicted Porsche Stock Price with textblob header analysis')
plt.plot(predicted_stock_price_textblob_content, color='blue', label='Predicted Porsche Stock Price with textblob content analysis')
plt.plot(predicted_stock_price_vader_content, color='cyan', label='Predicted Porsche Stock Price with vader content analysis')
plt.plot(predicted_stock_price_vader_header, color='magenta', label='Predicted Porsche Stock Price with vader header analysis')
plt.plot(predicted_stock_price_without_semantics, color='orange', label='Predicted Porsche Stock Price without semantics analysis')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\porsche\daily\prediction_porsche_with_all_' + date_today + '.png',
            bbox_inches="tight",
            dpi=100,
            pad_inches=1.5)
plt.show()
