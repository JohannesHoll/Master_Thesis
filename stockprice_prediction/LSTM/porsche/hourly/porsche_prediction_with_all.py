...
path = r'C:\Users\victo\Master_Thesis\merging_data\porsche\hourly\merged_files'
...
#plt.plot(X_test, color='black', label='Porsche Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\porsche\hourly\prediction_porsche_with_all_' + date_today + '.png',
            bbox_inches="tight",
            dpi=100,
            pad_inches=1.5)
plt.show()
