...
#plt.plot(new_df.OPEN, color='black', label='daimler Stock Price')
plt.plot(predicted_stock_price, color='green', label='Predicted daimler Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\daimler\daily\textblob\content\prediction_plot_with_semantics\prediction_daimler_with_semantics_' + date_today + '.png', bbox_inches="tight")
