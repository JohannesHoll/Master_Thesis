...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\peugeot\daily\flair\content\prediction_plot_with_semantics\prediction_peugeot_with_semantics_' + date_today + '.png', bbox_inches="tight")
