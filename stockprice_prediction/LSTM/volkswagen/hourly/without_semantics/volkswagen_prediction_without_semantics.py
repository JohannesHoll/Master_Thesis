...
#model.save(r'C:\Users\victo\Master_Thesis\stockprice_prediction\volkswagen\resultstest' + date_today + '.h5')
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\volkswagen\hourly\without_semantics\prediction_plot_without_semantics\prediction_volkswagen_without_semantics_' + date_today + '.png', bbox_inches="tight")
