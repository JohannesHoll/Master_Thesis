...
path = r'C:\Users\victo\Master_Thesis\merging_data\volkswagen\hourly\merged_files'
...
new_df_flair_content[['OPEN', 'HIGH', 'LOW', 'CLOSE', 'VOLUME', 'flair_sentiment_content_score']].astype(np.float64)
# print(new_df)
...
TIME_WINDOW_flair_content = 9
FORECAST_DISTANCE_flair_content = 2
...
new_df_flair_header[['OPEN', 'HIGH', 'LOW', 'CLOSE', 'VOLUME', 'flair_sentiment_header_score']].astype(np.float64)
# print(new_df)
...
# Creating target (y) and "windows" (X) for modeling
TIME_WINDOW_flair_header = 9
FORECAST_DISTANCE_flair_header = 2
...
new_df_textblob_content[['OPEN', 'HIGH', 'LOW', 'CLOSE', 'VOLUME', 'polarity_textblob_sentiment_content']].astype(np.float64)
# print(new_df)
...
# Creating target (y) and "windows" (X) for modeling
TIME_WINDOW_textblob_content = 9
FORECAST_DISTANCE_textblob_content = 2
...
# Creating target (y) and "windows" (X) for modeling
TIME_WINDOW_textblob_header = 9
FORECAST_DISTANCE_textblob_header = 2
...
new_df_vader_content[['OPEN', 'HIGH', 'LOW', 'CLOSE', 'VOLUME', 'compound_vader_articel_content']].astype(np.float64)
# print(new_df)
...
# Creating target (y) and "windows" (X) for modeling
TIME_WINDOW_vader_content = 9
FORECAST_DISTANCE_vader_content = 2
...
new_df_vader_header[['OPEN', 'HIGH', 'LOW', 'CLOSE', 'VOLUME', 'compound_vader_header']].astype(np.float64)
print(new_df_vader_header)
...
# Creating target (y) and "windows" (X) for modeling
TIME_WINDOW_vader_header = 9
FORECAST_DISTANCE_vader_header = 2
...
new_df_without_semantics[['OPEN', 'HIGH', 'LOW', 'CLOSE', 'VOLUME']].astype(np.float64)
print(new_df_without_semantics)
...
# Creating target (y) and "windows" (X) for modeling
TIME_WINDOW_without_semantics = 9
FORECAST_DISTANCE_without_semantics = 2
...
#plt.plot(X_test, color='black', label='Volkswagen Stock Price')
plt.plot(predicted_stock_price_flair_content, color='green', label='Predicted Volkswagen Stock Price with flair content analysis')
plt.plot(predicted_stock_price_flair_header, color='red', label='Predicted Volkswagen Stock Price with flair header analysis')
plt.plot(predicted_stock_price_textblob_header, color='yellow', label='Predicted Volkswagen Stock Price with textblob header analysis')
plt.plot(predicted_stock_price_textblob_content, color='blue', label='Predicted Volkswagen Stock Price with textblob content analysis')
plt.plot(predicted_stock_price_vader_content, color='cyan', label='Predicted Volkswagen Stock Price with vader content analysis')
plt.plot(predicted_stock_price_vader_header, color='magenta', label='Predicted Volkswagen Stock Price with vader header analysis')
plt.plot(predicted_stock_price_without_semantics, color='orange', label='Predicted Volkswagen Stock Price without semantics analysis')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\volkswagen\hourly\prediction_volkswagen_with_all_' + date_today + '.png',
            bbox_inches="tight",
            dpi=100,
            pad_inches=1.5)
plt.show()
