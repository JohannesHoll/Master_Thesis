...
#plt.plot(new_df.OPEN, color='black', label='volkswagen Stock Price')
plt.plot(predicted_stock_price, color='green', label='Predicted volkswagen Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\volkswagen\hourly\textblob\content\prediction_plot_with_semantics\prediction_volkswagen_with_semantics_' + date_today + '.png', bbox_inches="tight")
