...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\RandomForest_base_model\daimler\daily\prediction_daimler_with_semantics_' + date_today + '.png',
            bbox_inches="tight",
            dpi=100,
            pad_inches=1.5)
plt.show()
