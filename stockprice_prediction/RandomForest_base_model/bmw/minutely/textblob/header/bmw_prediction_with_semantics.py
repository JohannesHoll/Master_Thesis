...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\bmw\minutely\textblob\header\prediction_plot_with_semantics\prediction_bmw_with_semantics_' + date_today + '.png', bbox_inches="tight")
