...
new_df = concatenate_dataframe[['OPEN', 'HIGH', 'LOW', 'CLOSE', 'VOLUME', 'polarity_textblob_sentiment_content']]
new_df['polarity_textblob_sentiment_content'] = new_df['polarity_textblob_sentiment_content'].fillna(0)
...
#plt.plot(new_df.OPEN, color='black', label='volvo Stock Price')
plt.plot(predicted_stock_price, color='green', label='Predicted volvo Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\volvo\minutely\textblob\content\prediction_plot_with_semantics\prediction_volvo_with_semantics_' + date_today + '.png', bbox_inches="tight")
