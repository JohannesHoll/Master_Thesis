...
path = r'C:\Users\victo\Master_Thesis\merging_data\ferrari\merged_files'
...
plt.plot(test_dataset, color = 'black', label = 'Ferrari Stock Price')
...
#model.save(r'C:\Users\victo\Master_Thesis\stockprice_prediction\ferrari\resultstest' + date_today + '.h5')
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\ferrari\without_semantics\prediction_plot_without_semantics\prediction_ferrari_without_semantics_' + date_today + '.png', bbox_inches="tight")
