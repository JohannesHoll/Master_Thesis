...
plt.plot(test_dataset, color = 'black', label = 'Fiatchrysler Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\fiatchrysler\without_semantics\prediction_plot_without_semantics\prediction_fiatchrysler_without_semantics_' + date_today + '.png', bbox_inches="tight")
