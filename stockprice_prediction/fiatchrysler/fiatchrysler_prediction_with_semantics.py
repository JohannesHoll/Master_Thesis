...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\fiatchrysler\prediction_plot_with_semantics\prediction_fiatchrysler_with_semantics' + date_today + '.png', bbox_inches="tight")