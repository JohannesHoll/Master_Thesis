...
plt.plot(test_dataset, color = 'black', label = 'Fiat Chrysler Stock Price')
plt.plot(predicted_stock_price, color = 'green', label = 'Predicted Fiat Chrysler Stock Price')
plt.title('Fiat Chrysler Stock Price Prediction')
plt.xlabel('Time')
plt.ylabel('Fiat Chrysler Stock Price')
plt.legend()

date_today = str(datetime.now().strftime("%Y%m%d"))
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\fiatchrysler\prediction_plot_without_semantics\prediction_fiatchrysler_without_semantics_' + date_today + '.png', bbox_inches="tight")
