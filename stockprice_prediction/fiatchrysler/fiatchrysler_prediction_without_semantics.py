...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\fiatchrysler\prediction_plot_without_semantics\prediction_fiatchrysler_without_semantics' + date_today + '.png', bbox_inches="tight")