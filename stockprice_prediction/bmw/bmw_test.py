...
all_files = glob.glob(os.path.join(path, "bmwprices_with_semantics_2020-07-14.csv"))
...
concatenate_dataframe = pd.read_csv('C:/Users/victo/Master_Thesis/merging_data/bmw/merged_files/bmwprices_with_semantics_2020-07-10.csv', sep=',')
