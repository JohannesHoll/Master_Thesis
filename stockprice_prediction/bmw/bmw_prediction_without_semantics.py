...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\bmw\prediction_plot_without_semantics\prediction_bmw_without_semantics' + date_today + '.png', bbox_inches="tight")