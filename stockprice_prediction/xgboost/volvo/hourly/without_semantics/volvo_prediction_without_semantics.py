...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\volvo\hourly\without_semantics\prediction_plot_without_semantics\prediction_volvo_without_semantics_' + date_today + '.png', bbox_inches="tight")
