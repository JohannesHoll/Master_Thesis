...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\LSTM\daimler\minutely\without_semantics\prediction_plot_without_semantics\prediction_daimler_without_semantics_' + date_today + '.png', bbox_inches="tight")
