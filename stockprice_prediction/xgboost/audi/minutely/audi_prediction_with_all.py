...
plt.plot(xgboost_price_prediction_flair_content, color='green', label='Predicted Audi Stock Price with flair content analysis')
plt.plot(xgboost_price_prediction_flair_header, color='red', label='Predicted Audi Stock Price with flair header analysis')
plt.plot(xgboost_price_prediction_textblob_content, color='orange', label='Predicted Audi Stock Price with textblob content analysis')
plt.plot(xgboost_price_prediction_textblob_header, color='blue', label='Predicted Audi Stock Price with textblob header analysis')
plt.plot(xgboost_price_prediction_vader_content, color='cyan', label='Predicted Audi Stock Price with vader content analysis')
plt.plot(xgboost_price_prediction_vader_header, color='magenta', label='Predicted Audi Stock Price with vader header analysis')
plt.plot(xgboost_price_prediction_without_semantics, color='yellow', label='Predicted Audi Stock Price without semantics analysis')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\xgboost\audi\minutely\prediction_audi_with_all_' + date_today + '.png',
            bbox_inches="tight",
            dpi=100,
            pad_inches=1.5)
plt.show()
