...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\porsche\prediction_plot_with_semantics\prediction_porsche_with_semantics' + date_today + '.png', bbox_inches="tight")