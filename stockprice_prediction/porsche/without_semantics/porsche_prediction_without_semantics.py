...
path = r'C:\Users\victo\Master_Thesis\merging_data\porsche\merged_files'
...
plt.plot(test_dataset, color = 'black', label = 'Porsche Stock Price')
...
plt.savefig(r'C:\Users\victo\Master_Thesis\stockprice_prediction\porsche\without_semantics\prediction_plot_without_semantics\prediction_porsche_without_semantics_' + date_today + '.png', bbox_inches="tight")
