...
path = r'C:\Users\victo\Master_Thesis\preprocessing_of_news\porsche\preprocessed_news'

cleaned_dataframe.to_csv(path + '\preprocessed_porsche_news_' + str(current_date) + '.csv', index=False)