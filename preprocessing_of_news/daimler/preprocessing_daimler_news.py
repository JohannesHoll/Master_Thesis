...
path = r'C:\Users\victo\Master_Thesis\preprocessing_of_news\daimler\preprocessed_news'

cleaned_dataframe.to_csv(path + '\preprocessed_daimler_news_' + str(current_date) + '.csv', index=False)