...
path = r'C:\Users\victo\Master_Thesis\preprocessing_of_news\renault\preprocessed_news'

cleaned_dataframe.to_csv(path + '\preprocessed_renault_news_' + str(current_date) + '.csv', index=False)