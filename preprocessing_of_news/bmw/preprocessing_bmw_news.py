...
path = r'C:\Users\victo\Master_Thesis\preprocessing_of_news\bmw\preprocessed_news'

cleaned_dataframe.to_csv(path + '\preprocessed_bmw_news_' + str(current_date) + '.csv', index=False)